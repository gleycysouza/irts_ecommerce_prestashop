...
public class ComprarProdutosSteps {
	...
	public void seleciono_um_produto_na_posicao(Integer int1) {
		nomeProduto_HomePage = homePage.obterNomeProduto(int1);
		precoProduto_HomePage = homePage.obterPrecoProduto(int1);

		// System.out.println(nomeProduto_HomePage);
		// System.out.println(precoProduto_HomePage);

		produtoPage = homePage.clicarProduto(int1);
	...
	@Quando("adciono o produto no carrinho com tamanho {string} cor {string} e quantidade {int}")
	public void adciono_o_produto_no_carrinho_com_tamanho_cor_e_quantidade(String tamanhoProduto, String corProduto,
	...
	public void o_produto_aparece_na_confirmacao_com_o_nome_preco_tamanho_cor_e_quantidade(String nomeProduto,
