...
public class PedidoPage {
	...
	private By totalTaxaIncl = By.cssSelector("div.order-confirmation-table table tr.total-value td:nth-child(2)");
	...
	public Double obter_totalTaxaIncl() {
		return Funcoes.removeCifraoDevolveDouble(driver.findElement(totalTaxaIncl).getText());
	}
